...
class FruitContainer extends Component {
    ...
    handleFilter = (e) => {
        ...
        // remove the fruits that don't contain the filteredValue var
        const fruitFilteredList = this.state.fruitsToDisplay.filter(fruitItem => {
        ...
        this.setState({
            fruitsToDisplay: fruitFilteredList,
